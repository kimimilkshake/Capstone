...
echo "🎫 Testing 2-Passenger Booking (WITH PASSENGER TYPES)\n";
echo "====================================================\n\n";
...
try {
    ...
    // Passenger 1: Regular passenger (should receive email - FIRST PASSENGER)
    ...
    // Passenger 2: Child passenger (should NOT receive email - SECOND PASSENGER)
    ...
    echo "  1️⃣ Shem Cardoza (Regular) (shemcardoza7@gmail.com) - WILL RECEIVE EMAIL\n";
    echo "  2️⃣ Heisenberg Fritz (3 to 11 years old) (heisenbergfritz@gmail.com) - Will NOT receive email\n\n";
    ...
    echo "  Ticket 1: ₱1,500.00 (COT #101) - Shem Cardoza (Regular)\n";
    echo "  Ticket 2: ₱750.00 (COT #102) - Heisenberg Fritz (3 to 11 years old)\n\n";
    ...
    echo "  1. ticket_Shem_Cardoza.pdf (Regular)\n";
    echo "  2. ticket_Heisenberg_Fritz.pdf (3 to 11 years old)\n\n";

    echo "Email Body includes:\n";
    echo "  ✓ Voyage: {$voyage->voyage_code}\n";
    echo "  ✓ Passenger table with BOTH passengers listed with type\n";
    ...
    echo "   - Each PDF shows individual passenger info with TYPE ✓\n";
    echo "   - Passenger 1 (Regular) type shown in PDF ✓\n";
    echo "   - Passenger 2 (3 to 11 years old) type shown in PDF ✓\n";
