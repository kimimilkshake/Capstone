    ...
    <div class="staff-body">
        ...
        <div class="aci-form_container">
            ...
            <form action="{{ route('staff.cargo_item_update', $cargo_item->cargo_item_id) }}" method="POST">
                ...
                <div class="form-row"> <!-- First Row -->
                            ...
                            <select name="route_category_id" required>
                                @foreach ($route_categories as $routeCategory)
                                    <option value="{{ $routeCategory->route_category_id }}"
                                        {{ $cargo_item->route_category_id == $routeCategory->route_category_id ? 'selected' : '' }}>
                            ...
                            <select name="cargo_category_id" required>
                                @foreach ($cargo_categories as $category)
                                    <option value="{{ $category->cargo_category_id }}"
                                        {{ $cargo_item->cargo_category_id == $category->cargo_category_id ? 'selected' : '' }}>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" name="cargo_item_description"
                                value="{{ old('cargo_item_description', $cargo_item->cargo_item_description) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" name="cargo_item_freight"
                                value="{{ old('cargo_item_freight', $cargo_item->cargo_item_freight) }}" step="0.01"
                                min="0" required>
                        </div>
                    </div>
                ...
                <div id="measurement-section"
                    style="{{ $cargo_item->cargo_item_measure_required == 'Yes' ? 'display:block;' : 'display:none;' }}">
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" min="0" name="cargo_item_base_cbm"
                                    style="width: 150px"
                                    value="{{ old('cargo_item_base_cbm', $cargo_item->cargo_item_base_cbm) }}" required>
                            </div>
                        </div>
                    </div>
                </div>
