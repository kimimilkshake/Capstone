...
<head>
    ...
    <title>Ferry Ticket - Booking #{{ $bookingRef }}</title>
    <style>
        body {
        ...
        <div class="ticket-body">
            ...
            <div class="ticket-info-grid">
                ...
                <div class="info-section">
                    ...
                    @if ($route && $voyage && $vessel)
                        <div class="info-item">
                            <span class="info-label">Route:</span>
                            <span class="info-value">{{ $route->route_origin }} → {{ $route->route_destination }}</span>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <span
                                class="info-value">{{ \Carbon\Carbon::parse($voyage->voyage_departure_date)->format('M d, Y (D)') }}</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Time:</span>
                            <span
                                class="info-value">{{ \Carbon\Carbon::parse($voyage->voyage_estimated_TD)->format('g:i A') }}</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Port:</span>
                            <span class="info-value">{{ $route->port_origin_name ?? 'Main Port' }}</span>
                        </div>
                    @else
                        <div class="info-item">
                ...
                <div class="info-section">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><strong>#{{ $bookingRef }}</strong></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Booking Date:</span>
                        <span
                            class="info-value">{{ \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y g:i A') }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Passengers:</span>
                        <span class="info-value">{{ count($passengers) }}</span>
                    </div>
                    @if ($payment)
                        <div class="info-item">
            ...
            <div class="passengers-section">
                ...
                @foreach ($passengers as $index => $item)
                    <div class="passenger-card">
                        ...
                        <div class="passenger-details">
                            <div>
                                <strong>Age:</strong> {{ $item['passenger']->passenger_age }} years old
                            </div>
                            <div>
                                <strong>Gender:</strong>
                                {{ $item['passenger']->passenger_gender == 'M' ? 'Male' : 'Female' }}
                            </div>
                            <div>
                                <strong>Type:</strong> {{ $item['passenger']->passenger_type }}
                            </div>
                            <div>
                                <strong>Cot Number:</strong> <span
                                    style="background: #e3f2fd; padding: 2px 8px; border-radius: 4px; font-weight: bold;">{{ $item['ticket']->pt_cot_no }}</span>
                            </div>
                            <div>
                                <strong>Ticket Price:</strong> PHP
                                {{ number_format($item['ticket']->pt_ticket_price, 2) }}
                            </div>
                            @if ($item['passenger']->passenger_email)
                                <div>
                                    <strong>Email:</strong> {{ $item['passenger']->passenger_email }}
                                </div>
                            @endif
                        </div>
                    </div>
