...
<div class="admin-body">
    <h3 class="text-center mb-4">CARGO AUTO PLACEMENT</h3>
        ...
        <div class="scs-form_container">
            <form method="GET" action="<?php echo e(route('admin.cargo.placement')); ?>" class="mb-4">
    ...
    <script>
        ...
        async function initializeVisualization(voyageId) {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('admin.cargo.packing-data')); ?>?voyage_id=${voyageId}`, {
                    method: 'GET',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sophia\Documents\Capstone\resources\views/authorized/admin/admin_cargoautoplacement.blade.php ENDPATH**/ ?>