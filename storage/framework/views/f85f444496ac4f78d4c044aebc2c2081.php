    ...
    <div class="container-fluid my-5 px-3 px-xl-4">
        <div class="card shadow-sm mx-auto passenger-cargo-card" style="max-width:1520px; background-color:#f0f0f0;">
            ...
            <div class="card-body">
                ...
                <form id="passengerCargoForm" action="<?php echo e(route('cargobooking.confirm')); ?>" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="hidden" name="voyage_id" value="<?php echo e($voyage->voyage_id); ?>">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group has-validation">
                                                <select name="cargo_item_id[]"
                                                    ...
                                                    <?php $__currentLoopData = $cargoItems->sortBy('cargo_item_description'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cargo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($cargo->route_category_id == ($voyage->routePort->route_category_id ?? null)): ?>
                                                            <option value="<?php echo e($cargo->cargo_item_id); ?>"
                                                                data-route-category="<?php echo e($cargo->route_category_id ?? ''); ?>"
                                                                ...
                                                                data-measurement-unit="<?php echo e($cargo->measurementUnit->measurement_unit_abbreviation ?? 'cm'); ?>"
                                                                ...
                                                                data-base-cbm="<?php echo e($cargo->cargo_item_base_cbm ?? ''); ?>">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <select name="measurement_unit[]" class="form-select unitSelect">
                                                    <?php $__currentLoopData = $measurementUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $measurementUnit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($measurementUnit->measurement_unit_abbreviation ?: 'cm'); ?>">
                                                            <?php echo e($measurementUnit->measurement_unit_abbreviation ?: 'cm'); ?>
    ...
    <script>
        ...
        function applyMeasurementRules(item, selectedOption) {
            ...
            const hasPredefinedRange = measureRequired === 'yes' ||
                ...
                (selectedOption.dataset.maxWidth !== '' && selectedOption.dataset.maxWidth !== null) ||
                (selectedOption.dataset.minHeight !== '' && selectedOption.dataset.minHeight !== null) ||
                (selectedOption.dataset.maxHeight !== '' && selectedOption.dataset.maxHeight !== null);
            ...
            if (measureRequired === 'yes') {
                ...
                // Store that this has a predefined range
                item.dataset.hasPredefinedRange = 'true';
                item.dataset.baseCbmRequired = 'false';
            } else {
                if (lengthInput) {
                    lengthInput.value = '';
                ...
                // Store whether this has a predefined range and if base_cbm is required
