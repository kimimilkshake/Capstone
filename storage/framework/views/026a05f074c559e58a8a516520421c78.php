                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <h6>Booking Reference:
                            <?php echo e('LSLCBK' . \Carbon\Carbon::parse($booking->created_at)->format('y') . str_pad($booking->booking_ref_no, 6, '0', STR_PAD_LEFT)); ?>
                            ...
                            <?php $__currentLoopData = $passengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="border rounded p-3 mb-2">
                                    ...
                                    <div class="d-flex justify-content-between small mb-0">
                                        ...
                                        <div style="white-space: nowrap;">
                                            <?php if($basePrice !== null && ($routeRate > 0 || $typeDiscountPct > 0 || $item['ticket']->promo)): ?>
