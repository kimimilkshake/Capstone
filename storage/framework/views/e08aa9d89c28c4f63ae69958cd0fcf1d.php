                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $cargos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($c->classification ?? $c->cargo_item_id ?? '-'); ?></td>
                                    <td><?php echo e($c->description ?? ($c->cargo_item_description ?? '-')); ?></td>
                                    <td><?php echo e($c->shippers ?? '-'); ?></td>
                                    <td><?php echo e($c->tin_number ?? '-'); ?></td>
                                    <td><?php echo e($c->consignees ?? '-'); ?></td>
                                    <td><?php echo e($c->freight ?? $c->freight_charge ?? '-'); ?></td>
                                    <td><?php echo e($c->vat ?? '-'); ?></td>
                                    <td><?php echo e($c->stamp ?? '-'); ?></td>
                                    <td><?php echo e($c->total ?? '-'); ?></td>
                                    <td><?php echo e($c->receipt_no ?? ($c->cargo_receipt_id ?? '-')); ?></td>
                                    <td><?php echo e($c->net_arrastre ?? $c->arrastre ?? '-'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sophia\Documents\Capstone\resources\views/authorized/manifest.blade.php ENDPATH**/ ?>