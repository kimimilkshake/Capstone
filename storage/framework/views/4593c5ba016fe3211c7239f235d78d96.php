                                ...
                                <tbody>
                                    <?php $__currentLoopData = $placementData['hatches']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hatch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo e($hatch->hatch_capacity_per_hold); ?>

                                                tons<br>(<?php echo e(number_format($hCapKg)); ?> kg)</td>
                                            <td class="hatch-weight-cell" data-hatch-id="<?php echo e($hatch->hatch_id); ?>"
                                                data-capacity="<?php echo e($hCapKg); ?>" style="text-align: center;">
                                                <?php echo e(number_format($hUsedKg, 2)); ?> kg</td>
                                            <td class="hatch-available-cell" data-hatch-id="<?php echo e($hatch->hatch_id); ?>"
                                                style="text-align: center;"><?php echo e(number_format($hAvailKg, 2)); ?> kg</td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $placementData['cargoReceipts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr data-receipt-id="<?php echo e($receipt->cargo_receipt_id); ?>">
                                            <td style="text-align: center;"><?php echo e($receipt->cargo_receipt_id); ?></td>
                                            <td style="text-align: center;"><?php echo e($receipt->booking->booking_code); ?></td>
                                            <td><?php echo e($receipt->cargoItem->cargo_item_description ?? 'N/A'); ?></td>
                                            <td style="text-align: center;"><?php echo e($receipt->cargo_item_qty ?? 1); ?></td>
                                            <td style="text-align: center;">
                                                <?php if($booking): ?>
                                                    <?php echo e(number_format($lengthM, 2)); ?> &times;
                                                    <?php echo e(number_format($widthM, 2)); ?> &times;
                                                    <?php echo e(number_format($heightM, 2)); ?><br>
                                                    <small style="color: #666;">(<?php echo e($booking->length); ?> &times;
                                                        <?php echo e($booking->width); ?> &times; <?php echo e($booking->height); ?>
                                            ...
                                            <td style="text-align: center;" class="cargo-weight-cell">
                                                <?php echo e($booking->weight ?? 'N/A'); ?></td>
                                            <td style="text-align: center;">
