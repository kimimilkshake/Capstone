            ...
            <div class="form-col">
              ...
              <div class="form-group">
                ...
                <select id="promo_type" name="promo_type" required>
                  <option value="Discount" <?php echo e($promo->promo_type == 'Discount' ? 'selected' : ''); ?>>Discount</option>
                  <option value="Freebie" <?php echo e($promo->promo_type == 'Freebie' ? 'selected' : ''); ?>>Freebie</option>
                </select>
              </div>
            </div>
