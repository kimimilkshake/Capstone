                    ...
                    <div class="p-3">
                        ...
                        <?php $__currentLoopData = $booking->cargoBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-2">
                                ...
                                <div><strong>Dimensions:</strong> <?php echo e(number_format($c->length, 2)); ?> x <?php echo e(number_format($c->width, 2)); ?> x <?php echo e(number_format($c->height, 2)); ?> <?php echo e($unit); ?></div>
