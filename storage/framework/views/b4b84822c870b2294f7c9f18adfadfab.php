...
<table class="meta">
    <tr>
        ...
        <td><?php echo e($booking->booking_code ?? $booking->booking_ref_no); ?></td>
        <td class="label">Voyage No.</td>
        <td><?php echo e($booking->voyage->voyage_code ?? 'N/A'); ?></td>
    </tr>
    <tr>
        <td class="label">Vessel</td>
        <td><?php echo e($booking->voyage && $booking->voyage->vessel ? $booking->voyage->vessel->vessel_name : ($booking->voyage->vessel_name ?? 'N/A')); ?></td>
        <td class="label">Sailing Date</td>
        <td><?php echo e($booking->voyage ? \Carbon\Carbon::parse($booking->voyage->voyage_departure_date)->format('F d, Y') : 'N/A'); ?></td>
    </tr>
</table>
...
<table class="parties">
    <tr>
        ...
        <td>
            <div><strong><?php echo e($booking->sender->sender_name ?? ''); ?></strong></div>
            <div><?php echo e($booking->sender->sender_contactno ?? ''); ?></div>
            <div><?php echo e($booking->sender->sender_email ?? ''); ?></div>
        </td>
        <td class="label">Consignee</td>
        <td>
            <div><strong><?php echo e($booking->consignee->consignee_name ?? ''); ?></strong></div>
            <div><?php echo e($booking->consignee->consignee_contactno ?? ''); ?></div>
        </td>
    </tr>
</table>
...
<table class="ports">
    <tr>
        ...
        <td><?php echo e($booking->voyage && $booking->voyage->routePort ? $booking->voyage->routePort->port_origin_name : 'N/A'); ?></td>
        <td class="label">Unloading Port</td>
        <td><?php echo e($booking->voyage && $booking->voyage->routePort ? $booking->voyage->routePort->port_destination_name : 'N/A'); ?></td>
    </tr>
</table>
    ...
    <tbody>
        <?php $__currentLoopData = $booking->cargoBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cargo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td class="center"><?php echo e(number_format($cargo->length, 2) . $unit); ?></td>
                <td class="center"><?php echo e(number_format($cargo->width, 2) . $unit); ?></td>
                <td class="center"><?php echo e(number_format($cargo->height, 2) . $unit); ?></td>
                <td class="center"><?php echo e(number_format($cargo->weight, 2)); ?></td>
            </tr>
...
<table class="charges">
    <tr>
        ...
        <td class="right">PHP <?php echo e(number_format($freight, 2)); ?></td>
    </tr>
    <tr>
        <td class="label">STAMP</td>
        <td class="right">PHP <?php echo e(number_format($stamp, 2)); ?></td>
    </tr>
    <tr>
        <td class="label"><strong>TOTAL TRANSACTION</strong></td>
        <td class="right"><strong>PHP <?php echo e(number_format($total, 2)); ?></strong></td>
    </tr>
</table>
...
<?php /**PATH C:\Users\kirzt\Documents\GitHub\Capstone\resources\views/authorized/staff/bill_of_lading_pdf.blade.php ENDPATH**/ ?>