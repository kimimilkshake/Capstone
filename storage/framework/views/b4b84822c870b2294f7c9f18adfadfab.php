...
<?php $__empty_1 = true; $__currentLoopData = $cargoRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
<?php
$cargo = $row['cargo'];
