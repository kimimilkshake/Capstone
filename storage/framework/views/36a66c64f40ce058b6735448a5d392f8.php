...
<div class="staff-body">
	...
	<div class="search-filter-row mb-4" style="display:flex; gap:10px;">
		<form class="search-bar d-flex gap-2 align-items-stretch" action="<?php echo e(route('admin.cargo.bookings.pending')); ?>" method="GET" style="flex:1;">
			...
			<?php if(request('search') || request('booking_status')): ?>
				<a href="<?php echo e(route('admin.cargo.bookings.pending')); ?>" class="btn btn-outline-secondary">Clear</a>
			<?php endif; ?>
		</form>
	</div>
			...
			<?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				<tr>
					...
					<td class="d-flex gap-1">
						<a href="<?php echo e(route('admin.cargo.bookings.show', $b->booking_ref_no)); ?>" class="btn btn-sm btn-primary">View</a>
					</td>
				</tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kirzt\Documents\GitHub\Capstone\resources\views/authorized/admin/pendingcargo.blade.php ENDPATH**/ ?>