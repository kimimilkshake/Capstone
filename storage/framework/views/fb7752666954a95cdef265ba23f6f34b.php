...
<?php $__env->startSection('content'); ?>
    ...
    <div class="staff-body">
        ...
        <div class="search-add-row" style="display: flex; gap: 10px; margin-bottom: 20px; align-items: flex-end;">
            <form class="search-bar" action="<?php echo e(route('staff.voyage_list')); ?>" method="GET"
                ...
                <div style="flex: 2; display: flex; flex-direction: column;">
                    ...
                    <input type="text" name="search" placeholder="Search by name, code, route, vessel, status..."
                        value="<?php echo e(request('search')); ?>" style="height: 38px;">
                </div>

                <!-- FROM -->
                <div style="display: flex; flex-direction: column;">
                    <label style="font-size: 12px;">From</label>
                    <input type="date" name="start_date" value="<?php echo e(request('start_date')); ?>" style="height: 38px;">
                </div>

                <!-- TO -->
                <div style="display: flex; flex-direction: column;">
                    <label style="font-size: 12px;">To</label>
                    <input type="date" name="end_date" value="<?php echo e(request('end_date')); ?>" style="height: 38px;">
                </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $voyages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voyage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('staff.manifest', $voyage->voyage_id)); ?>" title="View Manifest"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kirzt\Documents\GitHub\Capstone\resources\views/authorized/staff/svoyage_list.blade.php ENDPATH**/ ?>