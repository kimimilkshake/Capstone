...
<body>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            ...
            <td style="width:160px; vertical-align:middle; text-align:center;">
                <img src="<?php echo e(public_path('images/logo_wo_name.png')); ?>" width="120" alt="Logo" />
            </td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td style="font-size:10px; color:#555; vertical-align:top;">
                E-TICKET NO.
                <br><strong style="font-size:18px; color:#1a3a6b;"><?php echo e($formattedETicket); ?></strong>
            </td>
                ...
                <?php if(!empty($qrCodes)): ?>
                    <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(isset($qrCodes[$ticket->passenger_id])): ?>
                            ...
                            <div style="font-size:11px; color:#555;"><?php echo e($formattedBookingRef); ?></div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
    ...
    <div
        ...
        1
        <br>
        Issued by System &nbsp;|&nbsp; <?php echo e(now()->format('F d, Y h:i A')); ?>
