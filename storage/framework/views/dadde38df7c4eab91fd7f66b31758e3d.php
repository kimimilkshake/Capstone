...
<div class="search-filter-row mb-4" style="display:flex; gap:10px;">
    <form class="search-bar d-flex gap-2 align-items-stretch" action="<?php echo e(route('cargo.bookings.pending')); ?>" method="GET" style="flex:1;">
        ...
        <select name="payment_status" class="form-select" style="max-width: 180px; height: 46px; border-radius: 0;">
            <?php $__currentLoopData = $allowedPaymentStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($status); ?>" <?php echo e(($selectedPaymentStatus ?? 'All') === $status ? 'selected' : ''); ?>>
                    <?php echo e($status); ?>
        ...
        <?php if(request('search') || request('booking_status') || request('payment_status')): ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e(optional($b->payment)->payment_status ?? 'N/A'); ?></td>
                    <?php
                    ...
                    <td class="d-flex gap-1">
                        ...
                        <?php endif; ?>
                        <?php if($b->booking_status === 'Confirmed' && optional($b->payment)->payment_status === 'Pending'): ?>
                            <button class="btn btn-sm btn-success pay-btn" data-booking-ref="<?php echo e($b->booking_ref_no); ?>">Pay Now</button>
                        <?php endif; ?>
                        <?php if($b->booking_status === 'Confirmed' && optional($b->payment)->payment_status === 'Initial'): ?>
                            <button class="btn btn-sm btn-success verify-btn" data-booking-ref="<?php echo e($b->booking_ref_no); ?>">Verify</button>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\clint\Desktop\Capstone\resources\views/authorized/staff/pendingcargo.blade.php ENDPATH**/ ?>