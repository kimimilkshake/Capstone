<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('success') || request('payment_success')): ?>
        <div class="alert alert-success alert-dismissible fade show text-center" role="alert"
            ...
            <p class="mb-0"><?php echo e(session('success') ?: ('Payment successful! Your booking reference is: ' . request('payment_success'))); ?></p>
        </div>
    <?php endif; ?>

    <!-- Centered Dropdown Error Alert (No Auto-dismiss) -->
    <?php if(session('error') || request('payment_error')): ?>
        <div class="alert alert-danger alert-dismissible fade show text-center" role="alert"
            ...
            <p class="mb-0"><?php echo e(session('error') ?: 'Payment could not be completed. Please try again.'); ?></p>
        </div>
    <?php endif; ?>
