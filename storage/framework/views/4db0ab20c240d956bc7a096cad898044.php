                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <?php if($viewPast): ?>
                            ...
                            <a href="<?php echo e(route('admin.cargo.placement')); ?>" class="btn btn-primary btn-sm">
                                <i class="fas fa-arrow-right"></i> View Upcoming
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('admin.cargo.placement', ['view' => 'past'])); ?>"
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    <?php $__currentLoopData = $voyages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voyage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($cargoCount === 0): ?>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('admin.cargo.placement', ['voyage_id' => $voyage->voyage_id])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sophia\Documents\Capstone\resources\views/authorized/admin/admin_cargo_placement_select.blade.php ENDPATH**/ ?>