...
<?php $__env->startSection('content'); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $placementData['cargoReceipts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($booking): ?>
                                                    <?php echo e(number_format($lengthM, 2)); ?> × <?php echo e(number_format($widthM, 2)); ?> × <?php echo e(number_format($heightM, 2)); ?><br>
                                                    <small style="color: #666;">(<?php echo e($booking->length); ?> × <?php echo e($booking->width); ?> × <?php echo e($booking->height); ?> <?php echo e($unitName); ?>)</small>
                                                <?php else: ?>
                                                    No dimensions
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td style="text-align: center;">
                                                <button class="btn btn-sm btn-primary isolate-btn" data-receipt-id="<?php echo e($receipt->cargo_receipt_id); ?>" onclick="cargoVisualizer.isolateItem('<?php echo e($receipt->cargo_receipt_id); ?>')">
    ...
    <script src="<?php echo e(asset('js/cargo-visualizer.js')); ?>" defer></script>
    <script>
        /**
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\clint\Desktop\Capstone\resources\views/authorized/staff/staff_cargoautoplacement.blade.php ENDPATH**/ ?>