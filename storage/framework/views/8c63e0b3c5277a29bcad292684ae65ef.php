...
<head>
    <meta charset="UTF-8">
    <title>Cargo Booking Approved - #<?php echo e($booking->booking_code); ?></title>
    <style>
...
<div class="container">
    ...
    <div class="payment-section">
        ...
        <div class="payment-amount">₱<?php echo e(number_format($payment->total_amount ?? ($total + $stampFee), 2)); ?></div>
        
        <a href="<?php echo e($paymentUrl); ?>" class="payment-button">Pay Now with GCash</a>
