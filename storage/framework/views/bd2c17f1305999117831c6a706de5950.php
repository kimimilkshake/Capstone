        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('bookingtype')); ?>">Book Now</a></li>
                    <li><a href="<?php echo e(route('schedules')); ?>">Schedules & Rates</a></li>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="footer-copyright mb-0">
                    &copy; <?php echo e(date('Y')); ?> Lapulapu Shipping Lines Corporation. All rights reserved.
                </p>
            </div>
        </div>
    </div>
</footer>
<?php /**PATH C:\Users\Shem\Desktop\Capstone\resources\views/components/footer.blade.php ENDPATH**/ ?>