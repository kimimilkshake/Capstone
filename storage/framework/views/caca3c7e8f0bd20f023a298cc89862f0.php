    ...
    <div class="staff-body">
        <div class="manifest-header" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <div style="display: grid; grid-template-columns: repeat(5, auto); gap: 10px 20px; margin-top: 1rem; justify-content: center; text-align: left; width: 100%; max-width: 1500px; margin-left: auto; margin-right: auto;">
                ...
                <div>
                    <p><strong>Actual Departure Date: </strong><?php echo e($voyage->voyage_actual_departure_date ? \Carbon\Carbon::parse($voyage->voyage_actual_departure_date)->format('F j, Y, D') : 'NULL'); ?></p>
                </div>
                <div>
                ...
                <div>
                    <p><strong>Actual Arrival Date: </strong><?php echo e($voyage->voyage_actual_arrival_date ? \Carbon\Carbon::parse($voyage->voyage_actual_arrival_date)->format('F j, Y, D') : 'NULL'); ?></p>
                </div>
                <div>
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $passengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php $__status = !empty($p->pt_boarded_at) ? 'Boarded' : (\Illuminate\Support\Facades\DB::table('booking')->where('booking_ref_no', $p->booking_ref)->value('booking_status') ?? '-'); ?>
                                    <td><?php echo e($__status === 'Confirmed' ? 'Not Boarded' : $__status); ?></td>
                                </tr>
