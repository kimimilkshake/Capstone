  ...
  <table class="rp-table">
    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $route_port; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
          <td><?php echo e($rp->route_code); ?></td>
          ...
          <td>
            <button 
                ...
                data-route_category_id="<?php echo e($rp->route_category_id); ?>"
            >
...
<div id="addRoutePortModal" class="modal-overlay" style="display:none;">
  <div class="modal-content">
    ...
    <form id="addRoutePortForm" method="POST" action="<?php echo e(route('admin.route_port_store')); ?>">
    <?php echo csrf_field(); ?>
      ...
      <div class="rpmodal-row three-col">
        <div class="rpmodal-col">
          ...
          <select name="route_category_id" id="route_category_id">
            ...
            <?php $__currentLoopData = $route_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($category->route_category_id); ?>"><?php echo e($category->route_category_name); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Shem\Desktop\Capstone\resources\views/authorized/admin/route_port_list.blade.php ENDPATH**/ ?>