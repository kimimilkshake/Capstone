            ...
            <div class="card-body bg-light">
                <div class="row text-center">
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <p class="mb-3 fw-bold"><?php echo e($vesselName); ?></p>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <p class="mb-3 fw-bold"><?php echo e(\Carbon\Carbon::parse($departureDate)->format('F d, Y')); ?></p>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <p class="mb-3 fw-bold"><?php echo e($portOfOrigin); ?></p>
